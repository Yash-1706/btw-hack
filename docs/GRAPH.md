...
still ships (`internal/graph`) because the product must degrade honestly when Graph is
...
Impact: AgentEvent.Validate (internal/model/event.go:236)
...
- selectEvents   (internal/derive/derive.go:243)
- finalize       (internal/normalize/normalize.go:234)
- FS.AppendEvent (internal/store/events.go:37)
- TestAgentEventValidate (internal/model/model_test.go:172)
